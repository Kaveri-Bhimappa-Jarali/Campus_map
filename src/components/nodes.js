...
const nodes = {
  MainEntrance:         { lat: 15.431261313098682, lng: 75.01260992331335, floorLevel: 0, building: "Main", floorLabel: "GF" },
  AcademicArea:         { lat: 15.430562502398589, lng: 75.01452152492303, floorLevel: 0, building: "Central", floorLabel: "GF" },
  AuditoriumAdmin:      { lat: 15.430416426978626, lng: 75.01439487742509, floorLevel: 0, building: "MagentaBlock", floorLabel: "GF" },
  AdministrativeBlock:  { lat: 15.43050181407361, lng: 75.0145830185025, floorLevel: 1, building: "MagentaBlock", floorLabel: "1F" },
  CSEBlock:             { lat: 15.430554803664092, lng: 75.01448120633201, floorLevel: 2, building: "MagentaBlock", floorLabel: "2F" },
  ISEBlock:             { lat: 15.430735790347253, lng: 75.01413251916007, floorLevel: 3, building: "CyanBlock", floorLabel: "3F" },
  ECEBlock:             { lat: 15.430813356020302, lng: 75.01368995467261, floorLevel: 2, building: "CyanBlock", floorLabel: "2F" },
  EEEBlock:             { lat: 15.43079056503788,  lng: 75.01362293989324, floorLevel: 1, building: "CyanBlock", floorLabel: "1F" },
  LibraryMBA:           { lat: 15.430231612765962, lng: 75.01417007008628, floorLevel: 1, building: "YellowBlock", floorLabel: "1F" },
  CivilBlock:           { lat: 15.429948386365824, lng: 75.01459221584862, floorLevel: 1, building: "GreenBlock", floorLabel: "1F" },
  PhysicsDepartment:    { lat: 15.430110155523051, lng: 75.01492174930672, floorLevel: 2, building: "GreenBlock", floorLabel: "2F" },
  ChemistryDepartment:  { lat: 15.430280737814906, lng: 75.01479502478675, floorLevel: 2, building: "GreenBlock", floorLabel: "2F" },
  ChemicalDepartment:   { lat: 15.430101,          lng: 75.01485,          floorLevel: 3, building: "GreenBlock", floorLabel: "3F" },
  MechanicalBlock:      { lat: 15.43018832041521, lng: 75.01572066620558, floorLevel: 0, building: "MechBlock", floorLabel: "GF" },
  AIMLBlock:            { lat: 15.43007843537352, lng: 75.01572737173498, floorLevel: 3, building: "CyanBlock", floorLabel: "3F" },
  Temple:               { lat: 15.430371311,      lng: 75.016125407, floorLevel: 0, building: "Temple", floorLabel: "GF" },
  Bank:                 { lat: 15.430516011263363, lng: 75.01499417718992, floorLevel: 0, building: "BankBlock", floorLabel: "GF" },
  CanteenSIC:           { lat: 15.430084228029813, lng: 75.01541528400526, floorLevel: 0, building: "Canteen", floorLabel: "GF" },
  Mess:                 { lat: 15.429020469181712, lng: 75.01478764709577, floorLevel: 0, building: "Mess", floorLabel: "GF" },
  BoysHostels:          { lat: 15.427980841815762, lng: 75.01582834419355, floorLevel: 0, building: "BoysHostel", floorLabel: "GF" },
  GirlsHostels:         { lat: 15.431201340411992, lng: 75.0134779885397, floorLevel: 0, building: "GirlsHostel", floorLabel: "GF" },
  Playground:           { lat: 15.427892932851313, lng: 75.01475009616956, floorLevel: 0, building: "Playground", floorLabel: "GF" },
  IndoorSports:         { lat: 15.4315, lng: 75.0178, floorLevel: 0, building: "Sports", floorLabel: "GF" },
  PlacementOffice:      { lat: 15.430249711469548, lng: 75.01422371426658, floorLevel: 0, building: "YellowBlock", floorLabel: "GF" },
  MBADepartment:        { lat: 15.430179902175558, lng: 75.01414861241416, floorLevel: 2, building: "YellowBlock", floorLabel: "2F" },
  Karavali:             { lat: 15.4305855929, lng:  75.0157201036, floorLevel: 0, building: "Karavali", floorLabel: "GF" },
  XeroxShop:            { lat: 15.430595935, lng: 75.0157804533, floorLevel: 0, building: "Karavali", floorLabel: "GF" },
  Student2WParking:     { lat: 15.4310057223, lng: 75.0151824285, floorLevel: 0, building: "Parking", floorLabel: "GF" },
  FacultyParking:       { lat: 15.4303265969, lng: 75.0149973924, floorLevel: 0, building: "Parking", floorLabel: "GF" },
  PostOffice:           { lat: 15.4305862827, lng: 75.0149609988, floorLevel: 0, building: "BankBlock", floorLabel: "GF" },
  TransportationSection: { lat: 15.4305855929, lng: 75.0156208618, floorLevel: 0, building: "Transport", floorLabel: "GF" },
};
...
const NODE_LABELS = {
  ...
  ChemicalDepartment: "Chemical Department",
...
const BASE_PINS = [
  ...
  },
  {
    ...
    label: "Chemical",
    group: "Departments",
    nodeKey: "ChemicalDepartment",
    ...toPct(latLngToXY(nodes.ChemicalDepartment.lat, nodes.ChemicalDepartment.lng).x, latLngToXY(nodes.ChemicalDepartment.lat, nodes.ChemicalDepartment.lng).y),
  },
  {
    id: "library",
    label: "Library",
